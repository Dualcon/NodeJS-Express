...
Now accessing HTML document using http://127.0.0.1:3000/ will generate a form. You can enter First and Last Name and then click submit button to see the result and it should give result as follows:
